    ...
    <Box sx={{ maxWidth: "900px", margin: "auto", padding: 2 }}>
      ...
      <Paper sx={{ padding: 3, marginBottom: 3, borderRadius: "10px" }}>
        <Stack spacing={2} direction={{ xs: "column", sm: "row" }} useFlexGap flexWrap="wrap">
          ...
          <TextField fullWidth label="Team University" variant="outlined" />
      ...
      <Stack spacing={2}>
        {matches.map((match) => (
          <Card key={match.id} sx={{ borderRadius: "10px", padding: 2 }}>
            <CardContent>
              <Stack direction="row" justifyContent="space-between" alignItems="center">
                <Typography variant="h6" fontWeight="bold">{match.team1}</Typography>
                <Typography variant="h6" fontWeight="bold">vs</Typography>
                <Typography variant="h6" fontWeight="bold">{match.team2}</Typography>
              </Stack>

              <Box textAlign="center" mt={1}>
                <Typography variant="body1">{match.dateTime}</Typography>
              ...
              <Box textAlign="center" mt={2}>
                {match.score !== "-" ? (
                  ...
                  <Button variant="contained" size="small">Update Scores</Button>
                )}
              </Box>
            </CardContent>
          </Card>
