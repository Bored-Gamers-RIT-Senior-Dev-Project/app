...
const University = () => {
  ...
  return (
    ...
    >
      ...
      <Paper sx={{ padding: 3, marginTop: 4, borderRadius: "12px", textAlign: "center" }}>
        <Button
          component="label"
          variant="contained"
                ...
                <Grid container alignItems="center" spacing={2}>
                  ...
                  <Grid item xs={3} textAlign="right">
                    <Select
                      defaultValue=""
                      onChange={(e) => {
                        if (e.target.value === "remove") handleRemoveTeam(team.id);
                      }}
                      sx={{
                        backgroundColor: "white",
                        minWidth: "120px",
                    ...
                    >
                      ...
                      <MenuItem value="remove" sx={{ color: "red", fontWeight: "bold" }}>
                        Remove Team
                      </MenuItem>
                    </Select>
                  </Grid>
      ...
      {selectedTab === 1 && (
        <Box sx={{ marginTop: 3 }}>
          <Typography variant="h6">Events will be displayed here...</Typography>
        </Box>
      )}
    </Box>
  );
