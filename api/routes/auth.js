...
router.post("/signup", async (req, res) => {
    try {
        const { Username, Password, Email, RoleID, ProfileImageURL, Bio, TeamID, UniversityID } = req.body;
        ...
        await db.query(
            ...
            [Username, hashedPassword, Email, RoleID, ProfileImageURL || null, Bio || null, TeamID || null, UniversityID || null]
        );
